...
class TimeZoneDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $edit = "<a href='".route('admin.time-zone.edit', $query->id)."' class='btn btn-primary' title='".__("Editar")."'><i class='fas fa-edit'></i></a>";
            $delete = "<a href='".route('admin.time-zone.destroy', $query->id)."' class='btn btn-danger delete-item ml-2' title='".__("Eliminar")."'><i class='fas fa-trash'></i></a>";
            return $edit . $delete;
        })
     ...
     */
    public function query(TimeZone $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id')->title(__('ID'))->width(80)->addClass('text-center'),
