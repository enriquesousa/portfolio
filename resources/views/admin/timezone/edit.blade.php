...
@section('content')
    <section class="section">
        ...
        <div class="section-header">
            ...
            @php
                $tituloPagina = __('Editar Zona Horaria');
            @endphp
            <h1>{{ $tituloPagina }}</h1>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.time-zone.update', $timezone->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ $timezone->name }}" autofocus>
                                    </div>
                                </div>
