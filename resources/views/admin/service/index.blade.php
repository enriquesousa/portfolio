    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            @php
                ...
                $subTituloPagina = __('Todos los Servicios');
            @endphp
            <h1>{{ $tituloPagina }}</h1>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <!-- Botón Vista Modal -->
                                <a href="javascript:void(0)" class="btn btn-warning" data-toggle="modal" data-target="#image-preview-modal" data-bs-title="{{ __('Vista Previa') }}" data-image="Servicios_opt__600.png" data-bs-width="480" data-bs-height="428" title="Ver donde queda este titulo en la sección">
